...
router.post('/:id/activity/all', activitiesController.getAllActivities);
...
router.get('/:id/get-reading-listening',  activitiesController.getReadingAndListeningGames);
router.post('/:id/material/create-image-quiz', activitiesController.uploadImageQuiz, activitiesController.addImageQuiz);
router.put('/:id/material/edit-image-quiz', activitiesController.uploadImageQuiz, activitiesController.editImageQuiz);
...
router.post('/:id/save-audio', activitiesController.conversationAudio, activitiesController.updateStudentRecord);
router.put('/:id/students-result', activitiesController.getConversationsResults);
router.put('/:id/update-score', activitiesController.updateConversationResult);
router.put('/:id/delete', activitiesController.deleteConversationResult);
router.put('/:id/add-conversation-below', activitiesController.addConversationBelow);
router.post('/:id/add-result', activitiesController.addGamesResult);
router.put('/:id/quiz-results', activitiesController.getGamesResults);
router.put('/:id/last-quiz-results', activitiesController.getLastGamesResults);
...
router.post('/get-progress', activitiesController.getProgress)
router.post('/newProgress', activitiesController.newProgress)
router.get('/:id/get-watchTime', activitiesController.getWatchTime)
router.post('/getReadingProgress',activitiesController.getReadingGameProgress)
